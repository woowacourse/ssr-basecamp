import { renderMoviePage } from "./movies.js";

export const renderMovieDetailPage = (movies, movieDetail) => {
  const moviesPageHTML = renderMoviePage(movies);
  return moviesPageHTML.replace(
    "<!--${MODAL_AREA}-->",
    /*html*/ `
        ...
        <div class="modal">
          ...
          <div class="modal-container">
            ...
            <div class="modal-description">
              ...
              <p class="category">${movieDetail.release_date} · ${movieDetail.genres
      .map(({ name }) => name)
      .join(", ")}</p>
